...
class ChatController extends GetxController {
  ...
  Future<void> loadChatMessages() async {
    try {
      ...
      if (_clientId != null && _counselorId != null) {
        ...
        await _dbService.markMessagesAsRead(_clientId!, _counselorId!, _clientId!);
 ...
 void setupMessageListener() {
  if (_clientId != null && _counselorId != null) {
    ...
    FirebaseDatabase.instance
      ...
      if (event.snapshot.exists) {
        ...
        ChatModel newMessage = ChatModel.fromMap(Map<String, dynamic>.from(value), value['id']);
        ...
        if (!messages.any((msg) => msg.id == newMessage.id)) {
          ...
          if (newMessage.senderId != _clientId) {
            _dbService.markMessagesAsRead(_clientId!, _counselorId!, _clientId!);
          }
        }
      }
    });
  ...
  Future<void> sendMessage() async {
    if (!canSendMessage.value || _clientId == null || _counselorId == null) return;
